...
class String
{
	size_t size; //разаер строки в байтах
	             //size_t - unsigned int
...
public:
	...
	{
		this->size = strlen(str) + 1; //strlen() возвращает размер строки в смволах
...
{
	setlocale(LC_ALL, "");
	//String str1=12; // explicit constructor нельзя так вызывать 
